...
const categories = ['T-Shirt', 'Trousers', 'Pants', 'Shoes', 'Sunglasses', 'Jacket', 'Perfume', 'Watch'];
...
export default function Shop() {
    ...
    useEffect(() => {
        apiClient.entities.Product.list('-created_date', 100)
            .then(p => { setProducts(p); setBrands([...new Set(p.map(x => x.brand))].sort()); setLoading(false); })
