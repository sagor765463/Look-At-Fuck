...
const categories = ['T-Shirts', 'Trousers', 'Pants', 'Accessories', 'Outerwear', 'Shoes', 'Jewelry', 'Premium'];

const empty = { name: '', brand: '', category: 'T-Shirts', price: '', old_price: '', description: '', image: '', in_stock: true, featured: false };
